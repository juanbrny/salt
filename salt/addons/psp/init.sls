...
{{ kubectl_apply_template("salt://addons/psp/podsecuritypolicy-lockdown.yaml.jinja",
                          "/etc/kubernetes/addons/podsecuritypolicy-lockdown.yaml") }}

{{ kubectl_apply_template("salt://addons/psp/podsecuritypolicy-unprivileged.yaml.jinja",
                          "/etc/kubernetes/addons/podsecuritypolicy-unprivileged.yaml") }}

{{ kubectl_apply_template("salt://addons/psp/podsecuritypolicy-privileged.yaml.jinja",
                          "/etc/kubernetes/addons/podsecuritypolicy-privileged.yaml") }}
